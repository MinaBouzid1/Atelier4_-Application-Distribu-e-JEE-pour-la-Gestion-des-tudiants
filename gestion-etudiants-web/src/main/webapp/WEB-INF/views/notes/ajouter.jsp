...
<head>
    ...
    <title>Ajouter une Note - FST Tanger</title>
...
<div class="container">
    <header class="header">
        <h1><i class="fas fa-plus-circle"></i> Ajouter une Note</h1>
    </header>
    ...
    <div class="content">
        ...
        <div class="form-container">
            <form method="post" action="<%= request.getContextPath() %>/notes/ajouter">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.5" min="0" max="20" id="note" name="note" required>
                </div>

                <div class="form-group">
                    <label for="dateNote" class="required">Date</label>
                    <input type="date" id="dateNote" name="dateNote" required>
                </div>
